        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AdminDetail>(entity =>
            {
                entity.HasKey(e => e.AdminId)
                    .HasName("PK__AdminDet__719FE4E8BF6B7962");

                entity.HasIndex(e => e.Email, "UQ__AdminDet__A9D1053494920D16")
                    .IsUnique();
            ...
            modelBuilder.Entity<AuthorisedCustomerBookingDetail>(entity =>
            {
                entity.HasKey(e => e.TicketId)
                    .HasName("PK__Authoris__712CC627D5078DBE");
                ...
                entity.Property(e => e.ReturnArrivalDate).HasColumnType("datetime");

                entity.Property(e => e.ReturnDepartureDate).HasColumnType("datetime");
            ...
            modelBuilder.Entity<AuthorisedCustomerDetail>(entity =>
            {
                entity.HasKey(e => e.CustomerId)
                    .HasName("PK__Authoris__A4AE64B87AF0370C");

                entity.HasIndex(e => e.LoginId, "UQ__Authoris__4DDA28398753A90A")
                    .IsUnique();

                entity.HasIndex(e => e.ContactNo, "UQ__Authoris__5C667C05528D9115")
                    .IsUnique();
            ...
            modelBuilder.Entity<BusDetail>(entity =>
            {
                entity.HasKey(e => e.BusId)
                    .HasName("PK__BusDetai__6A0F6095DB1C86E3");
            ...
            modelBuilder.Entity<CoachReservationDetail>(entity =>
            {
                entity.HasKey(e => e.ReservationId)
                    .HasName("PK__CoachRes__B7EE5F04D77EF2C3");
            ...
            modelBuilder.Entity<CoachResevationBusDetail>(entity =>
            {
                entity.HasKey(e => e.CoachBusId)
                    .HasName("PK__CoachRes__D4BB8A829121D31A");
            ...
            modelBuilder.Entity<DriverDetail>(entity =>
            {
                entity.HasKey(e => e.DriverId)
                    .HasName("PK__DriverDe__F1B1CD2493CD4B78");

                entity.HasIndex(e => e.LoginId, "UQ__DriverDe__4DDA2839B27496DC")
                    .IsUnique();

                entity.HasIndex(e => e.ContactNo, "UQ__DriverDe__5C667C054F57C65A")
                    .IsUnique();
            ...
            modelBuilder.Entity<Record>(entity =>
            {
                entity.HasKey(e => e.TravelId)
                    .HasName("PK__Records__E931521566BC9BE0");
            ...
            modelBuilder.Entity<UnauthorisedCustomerBookingDetail>(entity =>
            {
                entity.HasKey(e => e.BookingId)
                    .HasName("PK__Unauthor__73951ACD1156EDE3");
            ...
            modelBuilder.Entity<UnauthorisedCustomerDetail>(entity =>
            {
                entity.HasKey(e => e.Email)
                    .HasName("PK__Unauthor__A9D105357149A697");

                entity.HasIndex(e => e.ContactNo, "UQ__Unauthor__5C667C050848FD54")
                    .IsUnique();
